...
import { LayoutDashboard, Trophy, Users, Search, BarChart3, ShieldAlert, LogOut } from "lucide-react";

const navItems = [
  { path: "/o/dashboard", label: "Dashboard", icon: LayoutDashboard },
  { path: "/o/hackathons", label: "Hackathons", icon: Trophy },
  { path: "/o/teams", label: "Teams", icon: Users },
  { path: "/o/analysis", label: "Analysis", icon: Search },
  { path: "/o/plagiarism", label: "Plagiarism", icon: ShieldAlert },
  { path: "/o/leaderboard", label: "Leaderboard", icon: BarChart3 },
];
    ...
    <div style={{ display: "flex", minHeight: "100vh" }}>
      <aside className="sidebar">
        <div style={{ padding: "20px 20px", borderBottom: "1px solid var(--border-default)" }}>
          <Link to="/o/dashboard" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none", color: "inherit" }}>
            <div style={{
            ...
            <div>
              ...
              <div style={{ fontSize: 10, color: "var(--text-muted)" }}>Organizer</div>
            </div>
          </Link>
        </div>
